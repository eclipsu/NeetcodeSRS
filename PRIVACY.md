# NeetcodeSRS Privacy Policy

**Last Updated: July 12, 2026**

NeetcodeSRS is a Chrome extension that helps you with spaced repetition for
NeetCode and LeetCode problems. Your privacy is important. This policy explains what
information the extension handles and where it is stored.

## Data We Handle

NeetcodeSRS **does not** collect, transmit, or store any of your personal data on
...
1.  **On Your Local Machine (`chrome.storage.local`):**
    - Your saved problems (cards), including review history and notes.
...
NeetcodeSRS offers an optional feature to sync your data across browsers using
...
[github.com/eclipsu/NeetcodeSRS](https://github.com/eclipsu/NeetcodeSRS)
or visit [shrestharajeev.com.np](https://shrestharajeev.com.np/).
